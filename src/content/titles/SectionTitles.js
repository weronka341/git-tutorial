export const menuOptionsTitles = {
    ...
    COMMIT_EXERCISE: 'Ćwiczenie - git commit',
    GIT_STASH: 'Git stash',
    GIT_BRANCHING: 'Git branching',
    BRANCHING_EXERCISE: 'Ćwiczenie - git branch',
    GIT_REFS: 'Git refs',
    DETACHED_HEAD: 'Detached HEAD',
    GIT_RELATIVE_REFS: 'Wskazywanie rewizji',
    GIT_MERGE: 'Git merge',
    MERGE_EXERCISE: 'Ćwiczenie - git merge',
    MERGE_CONFLICTS: 'Merge conflicts',
    CHERRY_PICKING: 'Cherry-picking',
    GIT_REBASE: 'Git rebase',
    INTERACTIVE_REBASE: 'Interaktywny rebase',
    REBASE_EXERCISE: 'Ćwiczenie - git rebase',
    FIXING_MISTAKES: 'Naprawianie błędów',
    RESET_EXERCISE: 'Ćwiczenie - git reset',
